...
import { buildConversationThread, pause } from "./utils.ts";
...
//             elizaLogger.log(`Next tweet scheduled in ${randomMinutes} minutes`);
//         } else {
//             elizaLogger.log("Outside of allowed time range for tweet generation. Skipping.");
//         }

//         // Schedule the next loop (runs every 10 minutes)
//         setTimeout(() => {
//             generateNewTweetLoop(); // Set up next iteration
...
//     const processActionsLoop = async () => {
//         const actionInterval = this.client.twitterConfig.ACTION_INTERVAL; // Defaults to 5 minutes
//         console.log("checka 12");
//         // Check if within time range for action processing (9-10, 14-15, 18-19, 22-23)

//         if (isWithinTimeRange(9, 10) || isWithinTimeRange(14, 15) || isWithinTimeRange(18, 19) || isWithinTimeRange(22, 23) || isWithinTimeRange(0,12)) {
//             console.log("checka 13");

//             while (!this.stopProcessingActions) {
//         console.log("checka 14");
...
//             }
//         } else {
//             elizaLogger.log("Outside of allowed time range for action processing. Skipping.");
//         }

//         // Schedule the next loop (runs every 10 minutes)
//         setTimeout(() => {
//             processActionsLoop(); // Set up next iteration
//         }, 10 * 60 * 1000); // 10 minutes
//     };
